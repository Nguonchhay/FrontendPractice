        ...
        <div>
            <form onSubmit={handleSubmit(onSubmit)}>
                <div class="mb-4">
                    ...
                    <input readOnly={true} className="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" placeholder="Auto Generate"/>
                </div>
